locals {
  ...
  certificate_arn = var.create_certificate ? module.certificate[0].arn : var.certificate_arn
  agent_host_url  = var.create_certificate ? "https://${var.record_name}.${var.zone_name}" : var.superblocks_agent_host_url
}
